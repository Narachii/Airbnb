$(document).ready(function() {
  ...
  var html = `<div class="signUp-content" id="signUp-content">
								<div class="content-box">
									...
									<form class="new_user" id="new_user" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="lVo0gHC8WmbiNHXEh+FYkq+6uIDfYg0WpuYeoYpEqLwKxYKXe7Uysl47t/qmn1108tO4Rla93xOZq5CLRP2JNw==">
									<div class="field">
									...
									<span>By clicking Sign up or Continue with, I agree to Airbnb’s</span>
